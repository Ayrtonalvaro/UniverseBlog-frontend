      ...
      <footer className="p-4 mt-10  sm:p-6" id="contact">
        <div className="md:flex md:justify-center mt-5">
          ...
          <div className="grid grid-cols-1 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              <h2 className="mb-6 text-sm font-semibold  dark:text-yellow-300 uppercase">
                Recursos
              </h2>
            ...
            <div>
              <h2 className="mb-6 text-sm font-semibold uppercase dark:text-yellow-300 ">
                Seguime
              </h2>
              <ul className="dark:text-gray-300 ">
                <li className="mb-4">
                ...
                <li>
                  <a
                    href="https://www.linkedin.com/in/ayrton-alvaro-320a9424a/"
                    className="hover:underline"
                    target="_blank"
                    rel="noreferrer"
                  >
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a
              ...
              className="dark:text-gray-300  hover:text-yellow-500 dark:hover:text-yellow-400 "
              target="_blank"
              rel="noreferrer"
            >
              <svg
            ...
            <a
              ...
              className="dark:text-gray-300 hover:text-cyan-500 dark:hover:text-yellow-400   "
              target="_blank"
              rel="noreferrer"
            >
              <svg
